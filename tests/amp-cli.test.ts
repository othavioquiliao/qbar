...
import { AMP_INSTALL_COMMAND, AMP_MISSING_ERROR, findAmpBin, getAmpCandidatePaths } from '../src/amp-cli';

describe('amp-cli helpers', () => {
  it('uses the official Amp install command', () => {
    expect(AMP_INSTALL_COMMAND).toBe('curl -fsSL https://ampcode.com/install.sh | bash');
  });
